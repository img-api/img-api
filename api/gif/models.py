...
class DB_Gif(db.DynamicDocument):
    ...
    def __init__(self, *args, **kwargs):
        super(DB_Gif, self).__init__(*args, **kwargs)

    def save(self, *args, **kwargs):
        if not self.creation_date:
            self.creation_date = datetime.now()

        ret = super(DB_Gif, self).save(*args, **kwargs)
        return ret

    def delete(self, *args, **kwargs):
        return super(DB_Gif, self).delete(*args, **kwargs)
